...
if(!isset($_SESSION['name'])){
    header("location: https://localhost/SiteUX_Inventory/public_html/login");
}
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    ...
                    <a href="/">
                        <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img src="https://localhost/SiteUX_inventory/public_html/assets/images/logo-icon.png" alt="homepage" class="dark-logo" style="width:200px; margin-top: 20px;" />
                    </b>
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="https://localhost/SiteUX_inventory/public_html/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle" width="40">
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            Account Setting</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="https://localhost/SiteUX_inventory/public_html/includes/logout.php"><i data-feather="power"
                                class="svg-icon mr-2 ml-1"></i>
                            Logout</a>
                            <div class="dropdown-divider"></div>
