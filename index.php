...
<head>
    ...
    <title>Home - SiteUX Inventory</title>
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <?php
            ...
            include_once("./templates/sidebarmenu.html");
        ?>
                                ...
                                <div class="mt-4 activity">
                                    ...
                                    <div class="d-flex align-items-start border-left-line pb-3">
                                        ...
                                        <div class="ml-3 mt-2">
                                            ...
                                            <p class="font-14 mb-2 text-muted">Richardson just create support <br> ticket
                                            </p>
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        ...
                                                        <div class="">
                                                            <h5 class="text-dark mb-0 font-16 font-weight-medium">Daniel Kristeen
                                                            </h5>
